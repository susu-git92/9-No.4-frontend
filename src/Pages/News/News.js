      ...
      <div className="newsHeader" >
        <div className = "newsLogoWrapper">
          <div className = "wrapperwrapper">
            <img className={`newsHeader ${this.state.prevScrollpos > 0 && this.state. sizechanger === false ? "small" : ""}`} 
        ...
        <div className = "newsArticle">
          ...
          <div className="news-desc">
              ...
              <p className= "news-date"><time datetime="2020-06-15" class="__web-inspector-hide-shortcut__">2020년 6월 15일 월요일</time></p>
              <h2 className="news-title">
                <p>2020 봄-여름</p>
                <p>아이웨어 캠페인</p>
                <p>비하인드 신</p> 
